...
/**
 * ArchUnit test for resource classes.
 */
public class ResourceArchUnitTest extends AbstractArchUnitTest {

  @Test
  public void classesShouldBeAnnotatedWithPath() {
  ...
  @Test
  public void classesShouldHaveSuffixResource() {
    ArchRuleDefinition.classes()
        .that()
