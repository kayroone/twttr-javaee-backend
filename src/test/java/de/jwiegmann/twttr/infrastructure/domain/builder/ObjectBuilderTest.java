...
import de.jwiegmann.twttr.infrastructure.domain.value.AbstractSimpleValueObject;
...
public class ObjectBuilderTest {
  ...
  public void stringSubclass() {
    assertThat(
            ObjectBuilder.fromGenericType(StringSubclass.class, GenericSuperclass.class, 0)
                .getType())
  ...
  public void integerSubclass() {
    assertThat(
            ObjectBuilder.fromGenericType(IntegerSubclass.class, GenericSuperclass.class, 0)
                .getType())
  ...
  public void multipleGenericParameters() {
    assertThat(
            ObjectBuilder.fromGenericType(
                    MultiparameterSubclass.class, MultiparameterSuperclass.class, 0)
                .getType())
        .isEqualTo(String.class);
    assertThat(
            ObjectBuilder.fromGenericType(
                    MultiparameterSubclass.class, MultiparameterSuperclass.class, 1)
                .getType())
        .isEqualTo(Integer.class);
    assertThat(
            ObjectBuilder.fromGenericType(
                    MultiparameterSwitchingSubclass.class, MultiparameterSuperclass.class, 0)
                .getType())
        .isEqualTo(Integer.class);
    assertThat(
            ObjectBuilder.fromGenericType(
                    MultiparameterSwitchingSubclass.class, MultiparameterSuperclass.class, 1)
                .getType())
        .isEqualTo(String.class);
  }
  ...
  public void buildWithoutConstructor() {
    assertThat(ObjectBuilder.forType(ClassWithoutConstructor.class).build())
        .isInstanceOf(ClassWithoutConstructor.class);
  }

  @Test
  public void buildWithPrivateConstructor() {
    assertThat(ObjectBuilder.forType(ClassWithPrivateConstructor.class).build())
        .isInstanceOf(ClassWithPrivateConstructor.class);
  }
    ...
    assertThat(name)
        .isEqualTo(
            new TestMultiValueObject(
                new TestFirstSimpleValueObject("first"),
                new TestSecondSimpleValueObject("second")));
  }
  ...
  public void buildWithNullParameter() {
    TestMultiValueObject name =
        ObjectBuilder.forType(TestMultiValueObject.class)
            ...
            .build();
    assertThat(name)
        .isEqualTo(new TestMultiValueObject(null, new TestSecondSimpleValueObject("second")));
  }
  ...
  public void buildWithValidator() throws ReflectiveOperationException {
    ...
    TestSecondSimpleValueObject value =
        ObjectBuilder.forType(TestSecondSimpleValueObject.class)
            .withParameter("second")
    ...
    Constructor<TestSecondSimpleValueObject> constructor =
        TestSecondSimpleValueObject.class.getDeclaredConstructor(String.class);
    verify(executableValidator)
        .validateConstructorParameters(
            ArgumentMatchers.eq(constructor), aryEq(new Object[] {"second"}));
  }
  ...
  public void buildWithValidationError() throws ReflectiveOperationException {
    ...
    Constructor<TestSecondSimpleValueObject> constructor =
        TestSecondSimpleValueObject.class.getDeclaredConstructor(String.class);
    when(executableValidator.validateConstructorParameters(
            ArgumentMatchers.eq(constructor), aryEq(new Object[] {"second"})))
  ...
  private static class MultiparameterSwitchingSubclass
      extends MultiparameterInbetweenClass<String, Integer> {}
  ...
  private static class TestMultiValueObject extends AbstractValueObject {
    ...
    TestMultiValueObject(
        final TestFirstSimpleValueObject first, final TestSecondSimpleValueObject second) {
      this.first = first;
      this.second = second;
    }
    ...
    TestMultiValueObject(
        final Object first, final TestSecondSimpleValueObject second, final boolean convert) {
      this(
          convert
              ? new TestFirstSimpleValueObject(first.toString())
              : (TestFirstSimpleValueObject) first,
          second);
    }

    TestMultiValueObject(
        final Object first,
        final TestSecondSimpleValueObject second,
