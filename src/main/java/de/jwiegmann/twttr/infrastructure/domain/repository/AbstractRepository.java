 ...
 */
package de.jwiegmann.twttr.infrastructure.domain.repository;

import de.jwiegmann.twttr.infrastructure.domain.entity.EntityNotFoundException;
import de.jwiegmann.twttr.infrastructure.domain.entity.Identifiable;
...
public abstract class AbstractRepository<E extends Identifiable> implements Serializable {
   ...
   * @throws EntityNotFoundException Thrown to indicated that no entity was found for the given
   *     identifier.
   */
   ...
   */
  protected E getReference(final Long identifier) {

    LOG.debug(
        "Retrieving reference of entity {} with identifier {}", clazz.getSimpleName(), identifier);
